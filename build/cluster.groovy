...
def deploy() {
  sh "curl -X POST http://ivy1:8080/ivy/system/api/apps/default/test/deploy/released -u admin:admin -H 'X-Requested-By: curl' -F fileToDeploy=@test-app/target/deploy/test.zip"
}
