...
TaskA.TYPE=0
TaskA.customFields.STRING.CustomVarCharField1="task custom value from " + new Date()
TaskA.customFields.TIMESTAMP.BusinessMilestoneTimestamp=new DateTime()' #txt
Ce0 f5 template "" #txt
