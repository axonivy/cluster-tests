...
# build ivy project
mvn install -f ivy-test-cluster-project/pom.xml
...
http://localhost:9080/ivy/test/pro/ivy-test-cluster-project/127755AEEB3C441C/executeSqlQuery.ivp
# or to single nodes
http://localhost:9081/ivy/test/pro/ivy-test-cluster-project/127755AEEB3C441C/executeSqlQuery.ivp
http://localhost:9081/ivy/test/pro/ivy-test-cluster-project/127755AEEB3C441C/executeSqlQuery.ivp
